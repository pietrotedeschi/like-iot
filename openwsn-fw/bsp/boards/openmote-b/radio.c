...
// 0xe5:   7 dBm
//14 values
//level between 0 and 13

void radio_setTxPower(uint8_t level){

	//set new value
	//HWREG(RFCORE_XREG_TXPOWER) = 21 + (level*16);
	HWREG(RFCORE_XREG_TXPOWER) = 0xe5; //0xe5;
}
...
/* PORT_TIMER_WIDTH radio_get32MHzTick(void){
	return get_real_counter();
} */