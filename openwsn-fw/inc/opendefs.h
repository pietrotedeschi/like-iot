...
* Modified by: Pietro Tedeschi <ptedeschi at mail.hbku.edu.qa>, June 2019
*/
...
typedef uint32_t  errorparameter_t2;
...
typedef struct {
   ...
   uint8_t       antiJam;                                       // if 1, it is my antiJam packet
   bool          isGatheringProtocol;
   //the packet
