...
void task_sixtopNotifReceive(void) {
    ...
    case IEEE154_TYPE_CMD:
        if (msg->length>0) {
            ...
            if(msg->l2_frameType == IEEE154_TYPE_DATA && msg->payload[0] == PROTOCOL_ID){
...
//    	ieee154e_getASNFirstBytes() > ANTIJAM_STARTING_TIME - 100
//	    && 	ieee154e_getASNFirstBytes() < ANTIJAM_STOP_TIME
//    ) return;
