...
typedef struct {
   ...
   /*uint32_t                  txStartDataTime;
   uint32_t                  rxStartDataTime;
   uint32_t                  txEndDataTime;
   uint32_t                  rxEndDataTime;
   uint32_t                  txStartAckTime;
   uint32_t                  rxStartAckTime;
   uint32_t                  txEndAckTime;
   uint32_t                  rxEndAckTime;*/
