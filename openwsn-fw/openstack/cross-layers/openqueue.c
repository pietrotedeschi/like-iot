...
void openqueue_reset_entry(OpenQueueEntry_t* entry) {
   ...
   entry->l2_keyIdMode       = IEEE802154_SECURITY_KEYIDMODE;
   entry->l2_keyIndex        = IEEE802154_security_getBeaconKeyIndex();
   entry->antiJam                      = 0;
   entry->isGatheringProtocol          = 0;
}
