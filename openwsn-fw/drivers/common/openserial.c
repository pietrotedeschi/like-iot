...
owerror_t openserial_printInfoErrorCritical2(
      char             severity,
      uint8_t          calling_component,
      uint8_t          error_code,
      uint32_t         arg1,
...
owerror_t openserial_printInfo2(uint8_t calling_component, uint8_t error_code,
                              uint32_t arg1,
                              uint32_t arg2) {
   return openserial_printInfoErrorCritical2(
      SERFRAME_MOTE2PC_INFO,
      calling_component,
      error_code,
      arg1,
